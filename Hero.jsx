      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="gradient-text">Ganavi</span>
            </motion.h1>
            ...
            >
              Aspirant Exploring AI & Automation|Web & Full-Stack Development
            </motion.h2>
            ...
            >
              I design efficient,reliable and scalable system tools and software.
            </motion.p>
            ...
            >
              ...
              <div className="relative w-80 h-80 mx-auto">
                ...
                <div className="w-full h-full rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center overflow-hidden">
                  <img
                    src="C:\Users\Ganavi Girish\New folder\Portfolio\WhatsApp Image 2025-11-28 at 7.46.50 PM.jpeg"
                    alt="Ganavi"
