...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = 'service_yxvxbi9';
      const templateId = 'template_566gyku';
      const publicKey = 'hRsS0uX6IKqdQU3Kx';
  ...
  // Social links
  const socialLinks = [
    { icon: FaGithub, url: 'https://github.com/ganavigirish', label: 'GitHub', color: 'hover:text-gray-400' },
    { icon: FaLinkedin, url: 'https://www.linkedin.com/in/ganavi-g-3a8537358', label: 'LinkedIn', color: 'hover:text-blue-400' },
    { icon: FaInstagram, url: 'https://www.instagram.com/ganaviigirish', label: 'Instagram', color: 'hover:text-pink-400' },
  ];

  // Contact info
  const contactInfo = [
    { icon: FaEnvelope, text: 'ganavigirish79@gmail.com', href: 'mailto:ganavigirish79@gmail.com' },
